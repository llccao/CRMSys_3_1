  	...
  	<form action="${ctp}/plan/execute" method="post">
		...
		<table class="data_list_table" border="0" cellPadding="3"
			...
			<c:if test="${list !=null }">
				...
				<c:forEach items="${requestScope.list }" var="salesPlan">
				<tr>
					<td class="list_data_text"><fmt:formatDate value="${salesPlan.date }" pattern="yyyy-MM-dd"/></td>
					<td class="list_data_text" >${salesPlan.todo }</td>
					<td class="list_data_text" >${salesPlan.result }</td>
				</tr>
				</c:forEach> 
