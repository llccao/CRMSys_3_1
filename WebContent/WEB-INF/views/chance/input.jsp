...
<html>
 ...
 <body class="main">
	...
	<form:form id="chance" action="${ctp}/chance/save" method="POST" modelAttribute="chance">
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
			...
			<tr>
				<th>创建人</th>
				<form:hidden path="createBy.id" value="${sessionScope.user.id }"/>
				<td>${sessionScope.user.name }</td>
				<th>创建时间</th>
				<td><form:input id="createDate" path="createDate" readonly="readonly"/><span class="red_star">*</span></td>
			</tr>
		</table>
		<br /><br>
	</form:form>
