...
<html>
 ...
 <form:form id="chance" action="${ctp }/chance/dispatch" method="post" modelAttribute="chance">
  	<input id="id" name="id" type="hidden" value="${chance.id }"/>
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">				
			<tr>					
				...
				<th>指派时间</th>
				<td>
					<input id="designeeDate" name="designeeDate" readonly="readonly" type="text"/><span class="red_star">*</span>
				</td>
			</tr>
		</table>
	 </form:form>
